...
import { CategoriesBrandsModal } from '@/components/modal/CategoriesBrandsModal'
...
export default function InventoryPage() {
  ...
  const [categories, setCategories] = useState<Category[]>([
    ...
    { id: 'phones', name: 'هواتف ذكية', count: 3 },
    { id: 'accessories', name: 'إكسسوارات', count: 0 },
    { id: 'cases', name: 'أغطية وحماية', count: 0 },
    { id: 'chargers', name: 'شواحن وكوابل', count: 1 },
    { id: 'headphones', name: 'سماعات', count: 1 }
  ])
