// app/(dashboard)/admin/customers/CustomersClient.tsx
'use client'
...
export default function CustomersClient({ initialCustomers }: Props) {
  ...
  const statsCard = (
    <>
      <StatsCard title="عملاء غير نشطين" value={inactive} icon={AlertCircle} variant="danger" withGradient />
      <StatsCard title="إجمالي العملاء" value={total} icon={Users} variant="accent" />
    </>
  )
